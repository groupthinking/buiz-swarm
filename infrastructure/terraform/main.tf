# BuizSwarm AWS Infrastructure
# Terraform configuration for deploying the platform to AWS
...
terraform {
  ...
  backend "s3" {
    bucket         = "buizswarm-terraform-state"
    key            = "infrastructure/terraform.tfstate"
    region         = "us-east-1"
    encrypt        = true
    dynamodb_table = "buizswarm-terraform-locks"
  }
}
